/*
	Rollup.js v0.50.0
	Sun Oct 08 2017 11:48:40 GMT+0200 (CEST) - commit db5cafd8e222336b3a1475ad12866f39f6a7253f
...
class Variable {
	 ...
	 */
	assignExpressionAtPath ( path$$1, expression ) {}
	 ...
	 * @return {boolean}
	 */
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		return true;
	}
	 ...
	 * @return {boolean}
	 */
	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		return true;
	}
...
class ExecutionPathOptions {
	 ...
	 * @return {ExecutionPathOptions}
	 */
	getHasEffectsWhenCalledOptions ( calledNode, ref ) {
		if ( ref === void 0 ) ref = {};
...
class Node$1 {
	 ...
	 * @param {Node} expression
	 */
	bindAssignmentAtPath ( path$$1, expression ) {}
...
class StructuredAssignmentTracker {
	constructor () {
...
class LocalVariable extends Variable {
	...
	assignExpressionAtPath ( path$$1, expression ) {
		if ( path$$1.length > MAX_PATH_LENGTH ) {
			return;
		}
		if ( this.assignedExpressions.hasAtPath( path$$1, expression ) ) { return; }
		this.assignedExpressions.addAtPath( path$$1, expression );
		if ( path$$1.length > 0 ) {
			this.assignedExpressions.forEachAtPath( path$$1.slice( 0, -1 ), ( relativePath, node ) =>
				node.bindAssignmentAtPath( relativePath.concat( path$$1.slice( -1 ) ), expression ) );
		}
		if ( path$$1.length === 0 ) {
	...
	hasEffectsWhenAccessedAtPath ( path$$1, options ) {
		...
		return this.assignedExpressions.someAtPath( path$$1, ( relativePath, node ) =>
	...
	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		...
		return this.included
			|| this.assignedExpressions.someAtPath( path$$1, ( relativePath, node ) =>
				relativePath.length > 0
...
class UndefinedIdentifier extends Node$1 {
	hasEffects () {
		return false;
	}
	...
	hasEffectsWhenMutatedAtPath ( path$$1 ) {
		return path$$1.length > 0;
	}
...
class ArrowFunctionExpression extends Node$1 {
	...
	hasEffectsWhenAssignedAtPath ( path$$1 ) {
		...
		return this.hasEffectsWhenMutatedAtPath( path$$1.slice( 1 ) );
	}
	...
	hasEffectsWhenMutatedAtPath ( path$$1 ) {
		return this.included || path$$1.length > 0;
	}
...
class AssignmentExpression extends Node$1 {
	...
	hasEffectsWhenAccessedAtPath ( path$$1, options ) {
		return this.right.hasEffectsWhenAccessedAtPath( path$$1, options );
	}
}
...
class AssignmentPattern extends Node$1 {
	...
	bindAssignmentAtPath ( path$$1, expression ) {
		this.left.bindAssignmentAtPath( path$$1, expression );
	}
...
class ClassNode extends Node$1 {
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		return this.body.hasEffectsWhenCalledAtPath( path$$1, options )
			|| ( this.superClass && this.superClass.hasEffectsWhenCalledAtPath( path$$1, options ) );
	}
...
class ConditionalExpression extends Node$1 {
	bindAssignmentAtPath ( path$$1, expression ) {
		if ( this.testValue === UNKNOWN_VALUE ) {
			this.consequent.bindAssignmentAtPath( path$$1, expression );
			this.alternate.bindAssignmentAtPath( path$$1, expression );
		} else {
			this.testValue
				? this.consequent.bindAssignmentAtPath( path$$1, expression )
				: this.alternate.bindAssignmentAtPath( path$$1, expression );
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		return (
			this.testValue === UNKNOWN_VALUE && (
				this.consequent.hasEffectsWhenCalledAtPath( path$$1, options )
				|| this.alternate.hasEffectsWhenCalledAtPath( path$$1, options )
			)
		) || (
			this.testValue
				? this.consequent.hasEffectsWhenCalledAtPath( path$$1, options )
...
class ExportDefaultDeclaration extends Node$1 {
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		return this.declaration.hasEffectsWhenCalledAtPath( path$$1, options );
	}
...
class FunctionNode extends Node$1 {
	...
	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		...
		if ( path$$1[ 0 ] === 'prototype' ) {
			return this.prototypeObject.hasEffectsWhenMutatedAtPath( path$$1.slice( 1 ), options );
		}
		return true;
	}
...
class Identifier extends Node$1 {
	...
	bindAssignmentAtPath ( path$$1, expression ) {
		this._bindVariableIfMissing();
		if ( this.variable ) {
			this.variable.assignExpressionAtPath( path$$1, expression );
		}
	}
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		return !this.variable
			|| this.variable.hasEffectsWhenCalledAtPath( path$$1, options );
	}

	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		return !this.variable
			|| this.variable.hasEffectsWhenMutatedAtPath( path$$1, options );
	}
...
class LogicalExpression extends Node$1 {
	...
	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		return path$$1.length === 0
			|| this.hasEffectsWhenMutatedAtPath( path$$1.slice( 1 ), options );
	}

	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		const leftValue = this.left.getValue();
		if ( leftValue === UNKNOWN_VALUE ) {
			return this.left.hasEffectsWhenMutatedAtPath( path$$1, options )
				|| this.right.hasEffectsWhenMutatedAtPath( path$$1, options );
		}
		if ( (leftValue && this.operator === '||') || (!leftValue && this.operator === '&&') ) {
			return this.left.hasEffectsWhenMutatedAtPath( path$$1, options );
		}
		return this.right.hasEffectsWhenMutatedAtPath( path$$1, options );
	}
}
...
class MemberExpression extends Node$1 {
	...
	bindAssignmentAtPath ( path$$1, expression ) {
		...
		if ( this.variable ) {
			...
			this.object.bindAssignmentAtPath( [ UNKNOWN_KEY ].concat( path$$1 ), expression );
		} else {
			this.object.bindAssignmentAtPath( [ this.property.name ].concat( path$$1 ), expression );
		}
	}
	...
	hasEffectsWhenAccessedAtPath ( path$$1, options ) {
		...
		return this.object.hasEffectsWhenAccessedAtPath( [ this.computed ? UNKNOWN_KEY : this.property.name ].concat( path$$1 ), options );
	}
	...
	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		...
		return this.object.hasEffectsWhenAssignedAtPath( [ this.computed ? UNKNOWN_KEY : this.property.name ].concat( path$$1 ), options );
	}

	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		if ( this.variable ) {
			return this.variable.hasEffectsWhenCalledAtPath( path$$1, options );
		}
		return this.computed
			|| this.object.hasEffectsWhenCalledAtPath( [ this.property.name ].concat( path$$1 ), options );
	}

	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		if ( this.variable ) {
			return this.variable.hasEffectsWhenMutatedAtPath( path$$1, options );
		}
		if ( this.computed ) {
			return path$$1.length > 0 || this.object.hasEffectsWhenMutatedAtPath( [], options );
		}
		return this.object.hasEffectsWhenMutatedAtPath( [ this.property.name ].concat( path$$1 ), options );
	}
...
class ObjectExpression extends Node$1 {
	bindAssignmentAtPath ( path$$1, expression ) {
		...
		this._getPossiblePropertiesWithName( path$$1[ 0 ], PROPERTY_KINDS_WRITE ).properties.forEach( property =>
			property.bindAssignmentAtPath( path$$1.slice( 1 ), expression ) );
	}
	...
	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		...
		var ref = this._getPossiblePropertiesWithName( path$$1[ 0 ], PROPERTY_KINDS_WRITE );
		var properties = ref.properties;
		var hasCertainHit = ref.hasCertainHit;
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		...
		return !hasCertainHit || properties.some( property =>
			property.hasEffectsWhenCalledAtPath( path$$1.slice( 1 ), options ) );
	}
	...
	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		...
		return !hasCertainHit || properties.some( property =>
			property.hasEffectsWhenMutatedAtPath( path$$1.slice( 1 ), options ) );
	}
}

class ObjectPattern extends Node$1 {
	bindAssignmentAtPath ( path$$1, expression ) {
		this.properties.forEach( child => child.bindAssignmentAtPath( path$$1, expression ) );
	}
...
class Property extends Node$1 {
	bindAssignmentAtPath ( path$$1, expression ) {
		this.value.bindAssignmentAtPath( path$$1, expression );
	}
	...
	hasEffectsWhenCalledAtPath ( path$$1, options ) {
		...
		return this.value.hasEffectsWhenCalledAtPath( path$$1, options );
	}
	...
	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		...
		return this.value.hasEffectsWhenMutatedAtPath( path$$1, options );
	}
...
class RestElement extends Node$1 {
	...
	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		return this.argument.hasEffectsWhenAssignedAtPath( path$$1, options );
	}
...
class ThisExpression extends Node$1 {
	...
	hasEffectsWhenAccessedAtPath ( path$$1, options ) {
		return !(path$$1.length === 0
			|| (path$$1.length === 1 && options.hasSafeThis()));
	}

	hasEffectsWhenAssignedAtPath ( path$$1, options ) {
		return !(path$$1.length === 1 && options.hasSafeThis());
	}

	hasEffectsWhenMutatedAtPath ( path$$1, options ) {
		return !(path$$1.length === 0 && options.hasSafeThis());
	}
...
class VariableDeclarator extends Node$1 {
	bindAssignmentAtPath ( path$$1, expression ) {
		this.id.bindAssignmentAtPath( path$$1, expression );
	}
